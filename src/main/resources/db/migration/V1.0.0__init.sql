...
CREATE TABLE public.document
   ...
   --
ALTER TABLE ONLY public.utilisateur ADD CONSTRAINT utilisateur_pkey PRIMARY KEY (idutilisateur);
ALTER TABLE ONLY public.role ADD CONSTRAINT role_pkey PRIMARY KEY (id);
   ...
   --
ALTER TABLE ONLY public.detailsPaiement ADD CONSTRAINT detailsPaiement_pkey PRIMARY KEY (id);
   --
   -- Name: parametrage parametrage_pkey; Type: CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.parametrage ADD CONSTRAINT parametrage_pkey PRIMARY KEY (id);
   --
   -- Name: statut statut_pkey; Type: CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.statut ADD CONSTRAINT statut_pkey PRIMARY KEY (id);
   --
...
ALTER TABLE ONLY public.document ADD CONSTRAINT document_pkey PRIMARY KEY (id);
   ...
   --
ALTER TABLE ONLY public.convention ADD CONSTRAINT convention_pkey PRIMARY KEY (id);
   --
...
ALTER TABLE ONLY public.observation ADD CONSTRAINT observation_pkey PRIMARY KEY (id);
   ...
   --
ALTER TABLE ONLY public.paiement ADD CONSTRAINT paiement_pkey PRIMARY KEY (id);
   --
   -- Name: demande demande_pkey; Type: CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.demande ADD CONSTRAINT demande_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.demandeadhesion ADD CONSTRAINT demandeadhesion_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.demandecession ADD CONSTRAINT demandecession_pkey PRIMARY KEY (id);
   --
   -- Name: pme pme_pkey; Type: CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.pme ADD CONSTRAINT pme_pkey PRIMARY KEY (id);
   --
   -- Name: bonengagement bonengagement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.bonengagement ADD CONSTRAINT bonengagement_pkey PRIMARY KEY (id);
   --
   -- Name: demande fk_demande_pme; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.demande ADD CONSTRAINT fk_demande_pme FOREIGN KEY (pmeid) REFERENCES public.pme (id);
ALTER TABLE ONLY public.demandeadhesion ADD CONSTRAINT fk_demande_pme FOREIGN KEY (pmeid) REFERENCES public.pme (id);
ALTER TABLE ONLY public.demandecession ADD CONSTRAINT fk_demande_pme FOREIGN KEY (pmeid) REFERENCES public.pme (id);
   --
   -- Name: pme fk_pme_agent; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.pme ADD CONSTRAINT fk_pme_utilisateur FOREIGN KEY (utilisateurid) REFERENCES public.utilisateur (idutilisateur);
   --
...
ALTER TABLE ONLY public.demandecession ADD CONSTRAINT fk_demandecession_paiement FOREIGN KEY (paiementid) REFERENCES public.paiement (id);
   ...
   --
ALTER TABLE ONLY public.detailsPaiement ADD CONSTRAINT fk_detailsPaiement_paiement FOREIGN KEY (paiementid) REFERENCES public.paiement (id);
   --
   -- Name: demande fk_demande_statut; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.demande ADD CONSTRAINT fk_demande_statut FOREIGN KEY (statutid) REFERENCES public.statut (id);
ALTER TABLE ONLY public.demandeadhesion ADD CONSTRAINT fk_demandeadhesion_statut FOREIGN KEY (statutid) REFERENCES public.statut (id);
ALTER TABLE ONLY public.demandeadhesion ADD CONSTRAINT fk_demandecession_statut FOREIGN KEY (statutid) REFERENCES public.statut (id);
ALTER TABLE ONLY public.demandeadhesion ADD CONSTRAINT fk_demandeadhesion_demande FOREIGN KEY (demandeid) REFERENCES public.demande (id);
ALTER TABLE ONLY public.demandecession ADD CONSTRAINT fk_demandecession_demande FOREIGN KEY (demandeid) REFERENCES public.demande (id);
   --
   -- Name: convention fk_convention_pme; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.convention ADD CONSTRAINT fk_convention_pme FOREIGN KEY (pmeid) REFERENCES public.pme (id);
   --
   -- Name: convention fk_convention_agent; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.convention ADD CONSTRAINT fk_convention_utilisateur FOREIGN KEY (utilisateurid) REFERENCES public.utilisateur (idutilisateur);
   --
   --
ALTER TABLE ONLY public.convention ADD CONSTRAINT fk_convention_demande FOREIGN KEY (demandeid) REFERENCES public.demandecession (id);
 --
   -- Name: observation fk_observation_agent; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.observation ADD CONSTRAINT fk_observation_utilisateur FOREIGN KEY (utilisateurid) REFERENCES public.utilisateur (idutilisateur);
   --
   -- Name: observation fk_observation_demande; Type: FK CONSTRAINT; Schema: public; Owner: -
   --
ALTER TABLE ONLY public.observation ADD CONSTRAINT fk_observation_demandecession FOREIGN KEY (demandeid) REFERENCES public.demandecession (id);
ALTER TABLE ONLY public.utilisateur_roles ADD CONSTRAINT fk_utilisateur_roles_utilisateur FOREIGN KEY (Utilisateur_idutilisateur) REFERENCES public.utilisateur (idutilisateur);
ALTER TABLE ONLY public.utilisateur_roles ADD CONSTRAINT fk_utilisateur_roles_role FOREIGN KEY (roles_id) REFERENCES public.role (id);